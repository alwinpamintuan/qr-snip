...
const ICON_PATHS = {
  ...
  visibility: 'M12 5q3.8 0 6.8 2.1Q21.2 8.8 22.5 12q-1.3 3.2-3.7 4.9Q15.8 19 12 19t-6.8-2.1Q2.8 15.2 1.5 12q1.3-3.2 3.7-4.9Q8.2 5 12 5Zm0 2q-2.9 0-5.2 1.5Q4.9 9.7 3.7 12q1.2 2.3 3.1 3.5Q9.1 17 12 17t5.2-1.5q1.9-1.2 3.1-3.5-1.2-2.3-3.1-3.5Q14.9 7 12 7Zm0 2.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z',
  visibilityOff: 'm3.3 2 18.7 18.7-1.3 1.3-3.2-3.2Q15.1 20 12 20q-3.8 0-6.8-2.1Q2.8 16.2 1.5 13q.8-2 2.3-3.5L2 7.3 3.3 6l18.7 18.7-1.3 1.3-17.4-17.4ZM5.2 10.9Q4.3 11.8 3.7 13q1.2 2.3 3.1 3.5Q9.1 18 12 18q2.2 0 4-.9l-1.7-1.7a4 4 0 0 1-5.7-5.7L7.1 8.2q-1 .5-1.9 1.2ZM12 6q3.8 0 6.8 2.1 2.4 1.7 3.7 4.9-.7 1.8-2.1 3.3L19 14.9q.8-.8 1.3-1.9-1.2-2.3-3.1-3.5Q14.9 8 12 8q-.9 0-1.7.1L8.7 6.5Q10.3 6 12 6Z',
} as const;
